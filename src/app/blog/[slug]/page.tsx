        ...
        <article>
          <header className="relative py-24 md:py-40 text-white">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
              <h1 className="font-headline-display text-4xl md:text-6xl font-bold mb-4">
                {post.title}
              </h1>
          ...
          <div className="bg-background py-16">
            <div className="container mx-auto px-4">
              <div
                className="prose prose-lg dark:prose-invert max-w-4xl mx-auto font-body"
                dangerouslySetInnerHTML={{ __html: post.content }} // Fixed: was \_\_html
              />
                ...
                <div className="flex flex-wrap gap-2">
                  {post.tags.map((tag) => (
                    <Badge
                      key={tag}
                      variant="outline"
                      className="text-lg px-4 py-1 border-accent text-accent"
                    >
                      {tag}
                    </Badge>
                  ))}
